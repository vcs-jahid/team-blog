...
@section('body')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 align-self-center order-1 order-lg-2 mb-md-50">
                    <img class="img-fluid w-100" src="{{ asset('/') }}assets/images/about/philosophy.jpg" alt="philosophy-image">
                </div>
            </div>
        </div>
    </section>
    ...
    <section>
        <div class="container">
            <div class="row rounded bg-secondary">
                <!-- ceo image -->
                <div class="col-lg-5 rounded-left ceo-image" style="background-image: url({{ asset('/') }}assets/images/about/ceo.jpg);"></div>
                <div class="col-lg-7">
                    <!-- ceo content -->
                    <div class="p-5">
                        ...
                        <img src="{{ asset('/') }}assets/images/about/ceo-signature.png" alt="ceo-signature">
    ...
    <section class="fun-facts overlay-dark section-sm" style="background-image: url({{ asset('/') }}assets/images/background/cta.jpg);">
        <div class="container">
            <div class="row">
