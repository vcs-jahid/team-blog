...
@section('body')
    <section>
        <div class="hero-slider position-relative">
            <div class="hero-slider-item py-160" style="background-image: url({{ asset('/') }}assets/images/banner/banner-1.jpg);"
            ...
            <div class="hero-slider-item py-160" style="background-image: url({{ asset('/') }}assets/images/banner/banner-2.jpg);"
            ...
            <div class="hero-slider-item py-160" style="background-image: url({{ asset('/') }}assets/images/banner/banner-3.jpg);" data-icon="ti-money"
                 data-text="Finance">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
            ...
            <div class="hero-slider-item py-160" style="background-image: url({{ asset('/') }}assets/images/banner/banner-4.jpg);"
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                    <div class="card text-center">
                        ...
                        <div class="card-img-wrapper">
                            <img class="card-img-top rounded-0" src="{{ asset('/') }}assets/images/service/service-1.jpg" alt="service-image">
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                    <div class="card text-center">
                        ...
                        <div class="card-img-wrapper">
                            <img class="card-img-top rounded-0" src="{{ asset('/') }}assets/images/service/service-2.jpg" alt="service-image">
                        </div>
                        <div class="card-body p-0">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="card text-center">
                        ...
                        <div class="card-img-wrapper">
                            <img class="card-img-top rounded-0" src="{{ asset('/') }}assets/images/service/service-3.jpg" alt="service-image">
                        </div>
                        <div class="card-body p-0">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-5 pr-0 align-self-center">
                    <img class="img-fluid w-100" src="{{ asset('/') }}assets/images/client.png" alt="clients-image">
                </div>
